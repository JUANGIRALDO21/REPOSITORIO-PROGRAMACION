...
alert("El promedio de edad de las personas que cumplen con las condiciones es "+promedioEdad);
alert("El promedio de estatura de las personas que cumplen con las condiciones es "+promedioEstatura);
